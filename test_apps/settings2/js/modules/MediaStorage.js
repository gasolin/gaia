    ...
    var MediaStorage = {
      ...
      initAllVolumeObjects: function ms_initAllVolumeObjects() {
        ...
        for (var name in volumes) {
          ...
          // or external (e.g. a pluggable SD card). It does *not* work in
          // general, but it works for all officially-supported devices.
      ...
      changeDefaultStorage: function ms_changeDefaultStorage() {
        ...
        var popup =
          this._rootElement.querySelector('#default-location-popup-container');
        var cancelBtn =
