define('modules/Support', ['modules/Utils'],
  function(Utils) {
    'use strict';
    return {
      init: function support_init() {
        ...
        document.querySelector('[data-l10n-id="user-guide"]').onclick =
          function openUserGuide() { Utils.openLink(url) };
      ...
      getSupportInfo: function support_getInfo(callback) {
        ...
        var self = this;
        Utils.loadJSON('/resources/support.json', function loadSupportInfo(data) {
                ...
                callSupportInfo = [
                  {
                    ...
                    'href':
                      callSupportHref1Req.result['support.callsupport1.href']
                  }
                ];
