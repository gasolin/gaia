define(function() {
   ...
   * role="region" />) with reset/submit buttons: these buttons both return to
   * the previous panel when clicked, and each button has its own (optional)
   * callback.
   */
   ...
   * network types. The categories are 'gsm' and 'cdma'.
   */
  ...
  return {
    ...
    DeviceStorageHelper: DeviceStorageHelper,
    getMobileConnection: getMobileConnection,
    getBluetooth: getBluetooth,
    getNfc: getNfc,
    getSupportedNetworkInfo: getSupportedNetworkInfo,
    isIP: isIP,
